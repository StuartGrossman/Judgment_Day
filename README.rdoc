This is the Judgment_Day Application - 
Contributers of this App are
...
Testing Your tests should include model and request specs. Your group project will go much smoother if you write tests for your code before committing it. Do not check in a new feature without some testing.
...
Testing Try some advanced rspec features, or try using Capybara.
Authentication If you haven't used a gem for authentication, try out Devise
Authorization Try using CanCanCan for authorization.
...
User stories. What features will your app have? Set up your project and user stories in Trello. Using Trello or a similar project management tool is a requirement.
